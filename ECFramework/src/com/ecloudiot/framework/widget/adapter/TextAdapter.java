...
public class TextAdapter extends ArrayAdapter<String> {
	...
	private final static String TAG = TextAdapter.class.getSimpleName();
	...
	public TextAdapter(Context context, List<String> listData, int sId, int nId) {
		super(context, R.string.total_feeHint, listData);
		mContext = context;
		mListData = listData;
	...
	public TextAdapter(Context context, String[] arrayData, int sId, int nId) {
		super(context, R.string.total_feeHint, arrayData);
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView view;
		if (convertView == null) {
			view = (TextView) LayoutInflater.from(mContext).inflate(R.layout.widget_secondary_menu_item, parent, false);
		} else {
