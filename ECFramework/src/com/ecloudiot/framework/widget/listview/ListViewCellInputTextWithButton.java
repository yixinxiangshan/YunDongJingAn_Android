...
public class ListViewCellInputTextWithButton extends ListViewCellBase {

	private static String TAG = ListViewCellInputTextWithButton.class.getSimpleName();
	public ListViewCellInputTextWithButton(String cellType, Context context, ListViewBaseAdapter listViewBaseAdapter) {
	...
	public View getView(final int position, View convertView, ViewGroup parent, JsonObject dataObj) {
		...
		holder.editText.setText(data.inputText);
