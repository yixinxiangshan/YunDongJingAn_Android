...
public class HoloCircularProgressBar extends View {
	...
	/**
	 * The Horizontal inset calcualted in {@link #computeInsets(int, int)} depends on {@link #mGravity}.
	 */
	 ...
	 * The Thumb pos x.
	 *
	 * Care. the position is not the position of the rotated thumb. The position is only calculated in {@link #onMeasure(int, int)}
	 */
	...
	/**
	 * The Vertical inset calcualted in {@link #computeInsets(int, int)} depends on {@link #mGravity}..
	 */
	...
	public HoloCircularProgressBar(final Context context, final AttributeSet attrs) {
		this(context, attrs, R.attr.circularProgressBarStyle, 10);
	}
	 ...
	 *            the def style
	 */
	public HoloCircularProgressBar(final Context context, final AttributeSet attrs, final int defStyle, final int circleStrokeWidth) {
	 ...
	 */
	public int dipTopx(final Context context, final float dpValue) {
	...
	protected void onDraw(final Canvas canvas) {
		...
		if (isThumbEnabled()) {
			...
			mSquareRect.left = mThumbPosX - mThumbRadius / 6;
			mSquareRect.right = mThumbPosX + mThumbRadius / 6;
			mSquareRect.top = mThumbPosY - mThumbRadius / 6;
			mSquareRect.bottom = mThumbPosY + mThumbRadius / 6;
	...
	private void updateBackgroundColor() {
		...
		mBackgroundColorPaint.setStrokeWidth(mCircleStrokeWidth / 3);
	...
	private void updateMarkerColor() {
		...
		mMarkerColorPaint.setStrokeWidth(mCircleStrokeWidth / 3);
		invalidate();
	}
	...
	private void updateProgressColor() {
		...
		mProgressColorPaint.setStrokeWidth(mCircleStrokeWidth + 2);
