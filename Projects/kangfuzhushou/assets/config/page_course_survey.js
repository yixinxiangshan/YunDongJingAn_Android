...
(function() {
  ...
  ECpageClass = (function() {
    var root, _cfg, _have_cache, _have_press_position, _info, _local_answers, _mFirstSign, _mViewMethod, _now_index, _res, _server_answers;
    ...
    ECpageClass.prototype.onItemInnerClick = function(data) {
      var canGoNext, i, item, res, sign, value, _i, _len;
      canGoNext = true;
      if (_mViewMethod !== _cfg.radio && _mViewMethod !== _cfg.checkbox) {
        ...
        res = "";
        sign = true;
        for (i = _i = 0, _len = _have_press_position.length; _i < _len; i = ++_i) {
    ...
    ECpageClass.prototype.showSurvey_setAnswerToRes = function() {
      ...
      return $A().lrucache().get(_info.fav_id_id).then(function(data) {
        var i, item, _i, _j, _len, _len1, _ref, _ref1, _results, _results1;
        if (data !== "") {
        ...
        if (_server_answers != null) {
          ...
          for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
            ...
            if (_server_answers["" + item.id] != null) {
              _results.push(item.action = _server_answers["" + item.id]);
            } else {
          ...
          for (i = _j = 0, _len1 = _ref1.length; _j < _len1; i = ++_j) {
            ...
            if (_local_answers["" + item.id] != null) {
              _results1.push(item.action = _local_answers["" + item.id]);
            } else {
    ...
    ECpageClass.prototype.showSurvey_showForm = function(data) {
      var answers, done_count, form, item, list_data, mProcessFun, mViewType, _i, _len, _ref;
      list_data = [];
      done_count = 0;
      form = {};
      answers = {};
    ...
    ECpageClass.prototype.mViewMaker = function(list_data, form) {
      ...
      switch ("" + _mViewMethod) {
        ...
        case "checkbox":
          mViewType = "ListViewCellLine";
          mProcessFun = function(list_data, form, mViewType) {
            var i, item, option, value, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1;
            ...
            for (_l = 0, _len3 = _have_press_position.length; _l < _len3; _l++) {
              i = _have_press_position[_l];
              if (i !== 0) {
                root.mButton(list_data);
                return "_false";
              }
        ...
        default:
          mViewType = "ListViewCellLine";
          mProcessFun = function(list_data, form, mViewType) {
            var i, option, _i, _len, _ref, _results;
            _ref = form.content.split("\r\n");
            _results = [];
            for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
              option = _ref[i];
              _results.push(list_data.push({
                viewType: mViewType,
                _rightLayoutSize: 0,
                _leftLayoutSize: 40,
                _bottomDivider: _cfg.divider_config,
