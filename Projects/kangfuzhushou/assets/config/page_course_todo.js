...
(function() {
  ...
  ECpageClass = (function() {
    ...
    ECpageClass.prototype.onItemClick = function(data) {
      var i, item, position, updateItemsData, _i, _len, _ref;
      updateItemsData = [];
    ...
    ECpageClass.prototype.getNetResource = function() {
      return $A().lrucache().get(root._item_info.fav_id_id).then(function(data) {
        var key, keys, v, val, _i, _len, _ref;
        keys = data.split(",");
        _ref = root._item_info.item_lists;
        for (key in _ref) {
          val = _ref[key];
          val.checked = false;
    ...
    ECpageClass.prototype.itemCheck_saveFav_id_id = function(_listview_data) {
      var fav_id_ids, i, item, _i, _len, _ref;
      fav_id_ids = [];
      _ref = _listview_data.data;
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        item = _ref[i];
